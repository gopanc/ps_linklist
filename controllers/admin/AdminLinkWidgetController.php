...
class AdminLinkWidgetController extends ModuleAdminController
{
    ...
    public function renderForm()
    {
        ...
        $this->fields_form[0]['form'] = array(
            ...
            'input' => array(
                ...
                array(
                    'type' => 'account_pages',
                    'label' => $this->trans('Account content', array(), 'Modules.Linklist.Admin'),
                    'name' => 'account[]',
                    'values' => $this->repository->getAccountPages(),
                    'desc' => $this->trans('Please mark every page that you want to display in this block.', array(), 'Modules.Linklist.Admin')
                ),
                array(
                    'type' => 'custom_pages',
    ...
    private function manageLinkList() {
        ...
        if (!empty($id_hook)) {
            ...
            $content .= '"account":[' . (empty($account) ? 'false': '"' . implode('","', array_map('bqSQL', $account)) . '"') . ']}';
